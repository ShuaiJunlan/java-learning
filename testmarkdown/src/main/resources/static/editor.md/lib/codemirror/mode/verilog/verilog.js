...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "function generator genvar global highz0 highz1 if iff ifnone ignore_bins illegal_bins implements implies import " +
  ...
  */
  ...
  var blockKeywords = words(
    "case checker class clocking config function generator interface module package" +
