 ...
 * @date Created on 13:38 2018/4/14.
 */
...
import cn.shuaijunlan.zookeeper.zkbook.recovery.RecoveredAssignments;
import cn.shuaijunlan.zookeeper.zkbook.recovery.RecoveredAssignments.RecoveryCallback;
...
public class Master implements Watcher, Closeable {
    ...
    public static void main(String args[]) throws Exception {
        Master m = new Master(Constant.HOST_PORT);
        m.startZK();
